...
namespace Indolat\FilamentSimpleTheme;
...
use Indolat\FilamentSimpleTheme\Livewire\TopBarEnd;
use Indolat\FilamentSimpleTheme\Livewire\TopBarStart;
...
class FilamentSimpleThemeServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->commands([
           \Indolat\FilamentSimpleTheme\Console\FilamentSimpleThemeInstall::class,
        ]);
    ...
    public function boot(): void
    {
        ...
        FilamentView::registerRenderHook(
            ...
            fn() => Blade::render('@livewire(Indolat\FilamentSimpleTheme\Livewire\TopBarStart::class)')
        );
    }
}
